...
try {
    esbuild.build({
        ...
        fs.copyFileSync('.zeabur/output/functions/index.func/main.js', '.zeabur/output/functions/index.func/index.js')
        fs.rmSync('.zeabur/output/functions/index.func/main.js')
    })
} catch (error) {
    console.error(error)
}
